...
// Copyright 2026 Harry Bromley
//
// This file contains a Rust reimplementation of the permanent function from
// thewalrus/thewalrus/_permanent.py in XanaduAI/thewalrus.
// Modifications and Rust porting work Copyright 2026 Harry Bromley.
//
    ...
    T: SupportsPermanent,
{
    ...
    for bin_index in range {
        ...
        let direction = T::from_i8(match old_gray.cmp(&new_gray) {
            ...
            cmp::Ordering::Less => -2,
            cmp::Ordering::Equal => unreachable!("Consecutive Gray loops should always differ."),
        })
        .unwrap();
...
fn _permanent_single<T>(matrix: ArrayView2<T>) -> T
where
    T: SupportsPermanent,
{
    ...
    let total = gray_loops(&matrix, &mut row_comb, 1..=num_loops, true, 0);
    ...
    T: SupportsPermanent + Send + Sync,
{
    ...
    let total: T = (0..num_threads.min(num_loops))
        .into_par_iter() // Individual processes generated by rayon here
        .map(|thread_id| {
